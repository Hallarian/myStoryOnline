<?php
	...
	/**
	 * Friends Directory Display
	 */
	add_action('um_friends_directory_display', 'um_friends_directory_display');
	function um_friends_directory_display( $args ) {
		global $ultimatemember;
		...
		$file = um_path . 'templates/member-grid-friends.php';
		$theme_file = get_stylesheet_directory() . '/ultimate-member/templates/member-grid-friends.php';
