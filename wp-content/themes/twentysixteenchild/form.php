...
<form id="newStory" method="post" name="new_story" action="" onsubmit="return validateForm()">
    ...
    <div id="fieldsets">
      ...
      <fieldset class="current" id="theme_step">
        ...
        <div>
        <div class="theme">
          <input name="category" type="radio" value="22" id="theme_memory">
        ...
        <div class="theme">
          <input name="category" type="radio" value="23" id="theme_recipe">
        ...
        <div class="theme">
          <input name="category" type="radio" value="24" id="theme_travel">
        ...
        <div class="theme">
          <input name="category" type="radio" value="25" id="theme_sports">
        ...
        <div class="theme">
          <input name="category" type="radio" value="26" id="theme_bed_time">
        ...
        <div class="theme">
          <input name="category" type="radio" value="27" id="theme_vacations">
        ...
        <div class="theme">
          <input name="category" type="radio" value="28" id="theme_public_service">
        ...
        <div class="theme">
          <input name="category" type="radio" value="29" id="theme_family_history">
      ...
      <fieldset class="hidden" id="writing_step">
        ...
        <div>
          <textarea id="story" name="story" placeholder="Start writing story here:"></textarea>
        </div>
      </fieldset>
      ...
      <fieldset class="hidden" id="title_step">
        ...
        <div id="title_book">
          <input name="title" type="text" placeholder="Enter title:" id="title" maxlength="24">
          <p>*24 character maximum</p>
          <textarea name="dedication" id="dedication" placeholder="Enter your dedication: (Optional)" maxlength="50"></textarea>
      ...
      <fieldset class="hidden" id="share_step">
        ...
        <div>
          <div>
            <input name="sharing" type="radio" class="sharing" value="Private" id="private">
